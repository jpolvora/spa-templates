...
define('shell',['require','vue','text!./shell.html','text!./menu.html','./router.config','utils/pubsub'],(require) => {
    const Vue = require("vue");
